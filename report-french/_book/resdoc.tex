...
\smallskip \textsuperscript{2}Institut pour les océans et la pêche\\
...
Ce projet vise à fournir un avis scientifique à l'appui de la révision du plan de rétablissement du stock de sébaste aux yeux jaunes (\emph{Sebastes ruberrimus}) des eaux intérieures (\protect\hyperlink{ref-ifmp2018}{DFO 2018}), conformément aux directives stratégiques nationales (\protect\hyperlink{ref-dfo2009}{MPO 2009}; \protect\hyperlink{ref-dfo2013}{DFO 2013}). Il applique un cadre de simulation en boucle fermée (\protect\hyperlink{ref-anderson2020gfmp}{Anderson et al. 2020b}) pour évaluer le rendement des procédures de gestion de rechange en ce qui concerne les objectifs de rétablissement du stock de sébaste aux yeux jaunes des eaux intérieures.
...
Le Cadre pour la pêche durable du Canada jette les bases de l'approche de précaution en matière de gestion des pêches au Canada (\protect\hyperlink{ref-dfo2006}{MPO 2006}, \protect\hyperlink{ref-dfo2009}{2009}). Le Cadre de l'approche de précaution (\protect\hyperlink{ref-dfo2009}{MPO 2009}) repose sur la définition des points de référence biologiques qui définissent les cibles de la biomasse ainsi que les seuils de biomasse faible à éviter avec une probabilité élevée. L'approche exige que la mortalité par pêche soit ajustée par rapport à deux niveaux de l'état des stocks~: un point de référence supérieur du stock (RSS) et un point de référence limite (PRL) (figure~\ref{fig:pa-illustration}). Le PRL et le RSS délimitent trois zones d'état des stocks (« critique », « de prudence » et « saine »). Il faut établir un plan de rétablissement pour les stocks de poissons canadiens qui ont été évalués comme étant inférieurs au PRL, c.-à-d.~dans la zone critique (\protect\hyperlink{ref-dfo2009}{MPO 2009}), afin de les ramener au-dessus du PRL (\protect\hyperlink{ref-dfo2013}{DFO 2013}).


\begin{figure}[htb]

{\centering \pdftooltip{\includegraphics[width=3.8in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/pa-framework}}{Figure \ref{fig:pa-illustration}} 

}

\caption{Illustration du Cadre de l'approche de précaution du MPO. D'après MPO (\protect\hyperlink{ref-dfo2009}{2009}).}\label{fig:pa-illustration}
\end{figure}
En juin 2019, d'importantes modifications apportées à la \emph{Loi sur les pêches} du Canada ont légiféré de nombreux éléments clés du Cadre pour la pêche durable, qui sont enchâssés dans les dispositions sur les stocks de poissons (\link{https://laws-lois.justice.gc.ca/fra/lois/f-14/page-3.html\#h-1175547}{article 6 de la \emph{Loi sur les pêches}}). Les dispositions relatives aux stocks de poissons exigent que les principaux stocks soient gérés à des niveaux durables, en particulier à des niveaux de biomasse supérieurs au PRL. De plus, le paragraphe 6.2(1) stipule que si un grand stock de poissons a diminué en deçà de son PRL, un plan de rétablissement doit être établi pour reconstituer le stock au-dessus du PRL. Les grands stocks de poissons seront désignés en vertu d'un règlement, le premier lot de stocks devant l'être à l'automne 2020.
...
Le sébaste aux yeux jaunes des eaux intérieures est présent dans la zone de gestion 4B du poisson de fond en Colombie-Britannique (Figure~\ref{fig:map-4B}). Il devrait être désigné comme grand stock de poissons à l'automne 2020, date à laquelle sa gestion sera légiférée en vertu des dispositions sur les stocks de poissons. Le stock a été évalué comme étant inférieur au PLR en 2010 (\protect\hyperlink{ref-yamanaka2011}{Yamanaka et al. 2011}; \protect\hyperlink{ref-dfo2012}{DFO 2012a}). De ce fait, un plan de rétablissement a été élaboré et publié à l'annexe 9 du Plan de gestion intégrée des pêches de la région du Pacifique pour le poisson de fond (\protect\hyperlink{ref-ifmp2018}{DFO 2018}). Le stock de sébaste aux yeux jaunes des eaux intérieures est également inscrit en vertu de la \emph{Loi sur les espèces en péril} (LEP) comme espèce préoccupante (\protect\hyperlink{ref-cosewic2008}{COSEWIC 2008a}) et il est prévu que le Comité sur la situation des espèces en péril au Canada (COSEPAC) le réévaluera en 2020. Les résultats de ce projet pourraient guider la réévaluation du COSEPAC et, éventuellement, une évaluation du potentiel de rétablissement en vertu de la LEP, s'il y a lieu (voir l'annexe~\ref{app:cosewic}).


\begin{figure}[htb]

{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/InsideYE_Map_new_fr}}{Figure \ref{fig:map-4B}} 
...
{\centering \pdftooltip{\includegraphics[width=6.3in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/mse-chart-simple2}}{Figure \ref{fig:mse-chart-basic}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/mse-chart}}{Figure \ref{fig:mse-chart}} 
...
\end{enumerate}
Nous avons ajusté le délai de rétablissement initial de 80 ans (\protect\hyperlink{ref-ifmp2018}{DFO 2018}) à 56 ans dans la présente analyse, en fonction de la durée de génération estimée pour le sébaste aux yeux jaunes des eaux extérieures (\protect\hyperlink{ref-cox2020}{Cox et al. 2020}), en tenant compte de la directive selon laquelle le rétablissement doit être réalisé dans un délai de 1,5 à 2 durées de génération (\protect\hyperlink{ref-dfo2013}{DFO 2013}). Pour de plus amples renseignements sur la durée de génération, consulter l'annexe~\ref{app:biological-data}, section~\ref{sec:generation}. Nous avons fait passer la probabilité de réussite souhaitée de 56 \% à 95 \% pour tenir compte de la directive selon laquelle la probabilité de rétablissement doit être élevée, ainsi que des pratiques exemplaires internationales, où les politiques de nombreuses administrations visent à maintenir les stocks au-dessus du PRL avec une probabilité de 90 \% à 95 \% {[}18 à 19 fois sur 20{]} (\protect\hyperlink{ref-sainsbury2008}{Sainsbury 2008}; \protect\hyperlink{ref-mcilgorm2013}{McIlgorm 2013}).
...
En plus des objectifs susmentionnés, nous proposons de peaufiner les jalons définis dans le plan de rétablissement initial (\protect\hyperlink{ref-ifmp2018}{DFO 2018}) en ajoutant le texte en italiques comme suit~:
\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{5}
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-compare-SRA-MSY-panel}}{Figure \ref{fig:biomass-om}} 
...
{\centering \pdftooltip{\includegraphics[width=2.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/historical_indicators_ref_pt}}{Figure \ref{fig:ref-pt}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-compare-SRA-depletion-panel}}{Figure \ref{fig:depletion-om}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-compare-SRA-recdev-panel}}{Figure \ref{fig:recdev-om}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-compare-SRA-F-panel}}{Figure \ref{fig:F-om}} 
...
{\centering \pdftooltip{\includegraphics[width=0.8\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/SP_fit}}{Figure \ref{fig:spm-biomass}} 
...
{\centering \pdftooltip{\includegraphics[width=5.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/alt_SRA_fit}}{Figure \ref{fig:alt-SRA-fit}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-convergence}}{Figure \ref{fig:converge}} 
...
{\centering \pdftooltip{\includegraphics[width=3.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tigure-refset-avg}}{Figure \ref{fig:tigure-avg}} 
...
{\centering \pdftooltip{\includegraphics[width=3.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tigure-refset-min}}{Figure \ref{fig:tigure-min}} 
...
{\centering \pdftooltip{\includegraphics[width=0.8\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-not-sat2}}{Figure \ref{fig:proj-not-satisficed-eg}} 
...
{\centering \pdftooltip{\includegraphics[width=0.8\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tigure-refset}}{Figure \ref{fig:tigure-panel}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-dot-refset-avg}}{Figure \ref{fig:dot-lines}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tradeoff-refset-avg}}{Figure \ref{fig:tradeoff-reference}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-radar-refset-avg}}{Figure \ref{fig:spider-satisficed-mps-avg}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-index}}{Figure \ref{fig:proj-index}} 
...
{\centering \pdftooltip{\includegraphics[width=6.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-updog_fixsel}}{Figure \ref{fig:proj-updog-fixsel}} 
...
{\centering \pdftooltip{\includegraphics[width=6.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-lowcatch_fixsel}}{Figure \ref{fig:proj-low-catch}} 
...
{\centering \pdftooltip{\includegraphics[width=6.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-episodic_recruitment}}{Figure \ref{fig:proj-episodic-recruitment}} 
...
{\centering \pdftooltip{\includegraphics[width=6.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-upweight_dogfish}}{Figure \ref{fig:proj-upweight-dogfish}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-kobe}}{Figure \ref{fig:kobe}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-worms}}{Figure \ref{fig:worm}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-compare-SRA-nat-recdev-panel-proj}}{Figure \ref{fig:recdev-om-proj}} 
...
{\centering \pdftooltip{\includegraphics[width=5.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tigure-robset}}{Figure \ref{fig:tigure-panel-rob}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tradeoff-robset}}{Figure \ref{fig:tradeoff-robust}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-radar-robset}}{Figure \ref{fig:spider-satisficed-mps-robust}} 
...
{\centering \pdftooltip{\includegraphics[width=6.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-lowM_fixsel}}{Figure \ref{fig:proj-low-m}} 
...
{\centering \pdftooltip{\includegraphics[width=6.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-high_index_cv}}{Figure \ref{fig:proj-high-index-cv}} 
...
{\centering \pdftooltip{\includegraphics[width=0.9\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-projections-scenarios}}{Figure \ref{fig:proj-scenarios}} 
...
Albo, Y., Lanir, J., Bak, P., et Rafaeli, S. 2016. \link{https://doi.org/10.1109/TVCG.2015.2467322}{Off the Radar: Comparative Evaluation of Radial Visualization Solutions for Composite Indicators}. IEEE Trans. Vis. Comput. Graph. 22(1): 569‑578.

\leavevmode{\hypertarget{ref-sdmtmb}{}}%
Anderson, S.C., English, P.A., et Ward, E.J. 2020a. \link{https://github.com/pbs-assess/sdmTMB}{sdmTMB}: Spatiotemporal Species Distribution GLMMs with {TMB}. R package version 0.0.3.9000.
...
Anderson, S.C., Grandin, C., et Forrest, R.E. 2020d. \link{https://github.com/pbs-assess/gfdlm}{{ggmse}: Tools for Working with {openMSE} (Including {DLMtool}, {MSEtool}, and {SAMtool}). R package version 0.0.1.9000}.
...
Andrews, K.S., Nichols, K.M., Elz, A., Tolimieri, N., Harvey, C.J., Pacunski, R., Lowry, D., Yamanaka, K.L., et Tonnes, D.M. 2018. \link{https://doi.org/10.1007/s10592-018-1060-0}{Cooperative research sheds light on population structure and listing status of threatened and endangered rockfish species}. Conserv. Genet. 19(4): 865‑878.

\leavevmode{\hypertarget{ref-ayers2012}{}}%
Ayers, C., Dearden, P., et Rollins, R. 2012. \link{https://doi.org/10.1111/j.1541-0064.2012.00433.x}{An exploration of {Hul'qumi'num Coast Salish} peoples' attitudes towards the establishment of no-take zones within marine protected areas in the {Salish Sea, Canada}}. Can. Geogr. 56: 260‑274.

\leavevmode{\hypertarget{ref-beaudreau2007}{}}%
Beaudreau, A. H., et Essington, T.E. 2007. \link{https://doi.org/10.1577/t06-236.1}{Spatiotemporal patterns of rockfish bycatch in US west coast groundfish fisheries: opportunities for reducing incidental catch of depleted species}. Trans. Am. Fish. Soc. 136(5): 1438‑1452.

\leavevmode{\hypertarget{ref-berkson2015}{}}%
Berkson, J., et Thorson, J.T. 2015. \link{https://doi.org/10.1093/icesjms/fsu085}{The Determination of Data-Poor Catch Limits in the {United States}: Is There a Better Way?} ICES J. Mar. Sci. 72(1): 237‑242.
...
Butterworth, D.S., et Punt, A.E. 1999. \link{https://doi.org/10.1006/jmsc.1999.0532}{Experiences in the Evaluation and Implementation of Management Procedures}. ICES J. Mar. Sci. 56(6): 985‑998.

\leavevmode{\hypertarget{ref-carruthers2018}{}}%
Carruthers, T.R., et Hordyk, A. 2018a. \link{https://doi.org/10.1111/2041-210X.13081}{The Data-Limited Methods Toolkit ({DLMtool}): An {R} package for informing management of data-limited populations}. Methods Ecol. Evol. 9: 2388‑2395.

\leavevmode{\hypertarget{ref-carruthers_hordyk_2018}{}}%
Carruthers, T.R., et Hordyk, A.R. 2018b. \link{https://doi.org/10.1139/cjfas-2018-0223}{Using management strategy evaluation to establish indicators of changing fisheries}. Can. J. Fish. Aquat. Sci.: 1‑16.

\leavevmode{\hypertarget{ref-carruthers2016}{}}%
Carruthers, T.R., Kell, L.T., Butterworth, D.D.S., Maunder, M.N., Geromont, H.F., Walters, C., McAllister, M.K., Hillary, R., Levontin, P., Kitakado, T., et Davies, C.R. 2016. \link{https://doi.org/10.1093/icesjms/fsv212}{Performance Review of Simple Management Procedures}. ICES J. Mar. Sci. J. Cons. 73(2): 464‑482.

\leavevmode{\hypertarget{ref-cosewic2008}{}}%
COSEWIC. 2008a. {COSEWIC} assessment and status report on the {Yelloweye Rockfish} ({\emph{Sebastes ruberrimus}}), {Pacific Ocean} inside waters population and {Pacific Ocean} outside waters population, in {Canada}. {Committee} on the {Status} of {Endangered} {Wildlife} in {Canada}.

\leavevmode{\hypertarget{ref-cosewic2008b}{}}%
COSEWIC. 2008b. {COSEWIC} assessment and update status report on the {Killer Whale ({\emph{Orcinus orca}}) {Southern Resident} population, {Northern Resident} population, {West Coast Transient} population, {Offshore} population and {Northwest Atlantic/Eastern Arctic} population in {Canada}}. viii + 65 p. {Committee} on the {Status} of {Endangered} {Wildlife} in {Canada}.

\leavevmode{\hypertarget{ref-cosewic2015}{}}%
COSEWIC. 2015. \link{http://cosewic.ca/index.php/en-ca/assessment-process/wildlife-species-assessment-process-categories-guidelines/quantitative-criteria}{{COSEWIC} Assessment Process, Categories and Guidelines}. {Committee} on the {Status} of {Endangered} {Wildlife} in {Canada}.
...
Cox, S.P., Doherty, B., Benson, A.J., Johnson, S.D., et Haggarty, D. 2020. Évaluation des stratégies de rétablissement possibles pour le sébaste aux yeux jaunes des eaux extérieures de la {Colombie-Britannique}. Secr. can. de consult. sci. du MPO. Doc. de rech. 2020/069: ix + 151 p.

\leavevmode{\hypertarget{ref-cox2008a}{}}%
Cox, S.P., et Kronlund, A.R. 2008. \link{https://doi.org/10.1016/j.fishres.2008.05.006}{Practical Stakeholder-Driven Harvest Policies for Groundfish Fisheries in {British Columbia}, {Canada}}. Fish. Res. 94(3): 224‑237.
...
Diehl, S., Beck, F., et Burch, M. 2010. \link{https://doi.org/10.1109/TVCG.2010.209}{Uncovering Strengths and Weaknesses of Radial Visualizations --- an Empirical Approach}. IEEE Trans. Vis. Comput. Graph. 16(6): 935‑942.

\leavevmode{\hypertarget{ref-dowling2015a}{}}%
Dowling, N.A., Dichmont, C.M., Haddon, M., Smith, D.C., Smith, A.D.M., et Sainsbury, K. 2015. \link{https://doi.org/10.1016/j.fishres.2014.09.013}{Guidelines for Developing Formal Harvest Strategies for Data-Poor Species and Fisheries}. Fish. Res. 171: 130‑140.

\leavevmode{\hypertarget{ref-dunne2016}{}}%
Dunne, J.A., Maschner, H., Betts, M.W., Huntly, N., Russel, R., Williams, R.J., et Wood, S.A. 2016. \link{https://doi.org/10.1038/srep21179}{The roles and impacts of human hunter-gathers in {North Pacific} marine food webs}. Sci. Rep. 6: 21179.

\leavevmode{\hypertarget{ref-eckert2018}{}}%
Eckert, L.E., Ban, N.C., Frid, A., et McGreer, M. 2018. \link{https://doi.org/10.1002/aqc.2834}{Diving back in time: Extending historical baselines for yelloweye rockfish with {Indigenous} knowledge}. Aquat. Conserv. 28(1): 158‑166.

\leavevmode{\hypertarget{ref-feldman2013}{}}%
Feldman, R. 2013. \link{https://doi.org/10.1007/s11205-012-0028-6}{Filled Radar Charts Should Not Be Used to Compare Social Indicators}. Soc. Indic. Res. 111(3): 709‑712.
...
Forrest, R.E., Anderson, S.C., Grandin, C.J., et Starr, P.J. 2020. Évaluation de la morue du {Pacifque} ({\emph{Gadus macrocephalus}}) pour le détroit d'{Hécate} et le bassin de la {Reine-Charlotte (zone 5ABCD)}, ainsi que pour la côte ouest de l'île de {Vancouver} (zone {3CD}) en 2018. Secr. can. de consult. sci. du MPO. Doc. de rech. 2020/070(Canadian Science Advisory Secretariat (CSAS) 2019/nnn): v + 226 p.

\leavevmode{\hypertarget{ref-forrest2018}{}}%
Forrest, R.E., Holt, K.R., et Kronlund, A.R. 2018. \link{https://doi.org/10.1016/j.fishres.2018.04.007}{Performance of Alternative Harvest Control Rules for Two {Pacific} Groundfish Stocks with Uncertain Natural Mortality: {Bias}, Robustness and Trade-Offs}. Fish. Res. 206: 259‑286.

\leavevmode{\hypertarget{ref-forrest2010}{}}%
Forrest, R.E., McAllister, M.K., Dorn, M.W., Martell, S.J.D., et Stanley, R.D. 2010. \link{https://doi.org/10.1139/F10-077}{Hierarchical {Bayesian} Estimation of Recruitment Parameters and Reference Points for {Pacific} Rockfishes ({Sebastes} Spp.) under Alternative Assumptions about the Stock\textendash{}Recruit Function}. Can. J. Fish. Aquat. Sci. 67(10): 1611‑1634.

\leavevmode{\hypertarget{ref-forrest2015}{}}%
Forrest, R.E., Savina, M., Fulton, E.A., et Pitcher, T.J. 2015. \link{http://dx.doi.org/10.1016/j.fishres.2015.03.010}{Do marine ecosystem models give consistent policy evaluations? A comparison of {Atlantis} and {Ecosim}}. Fish. Res. 167: 293‑312.

\leavevmode{\hypertarget{ref-geromont2015}{}}%
Geromont, H.F., et Butterworth, D.S. 2015. \link{https://doi.org/10.1093/icesjms/fsu017}{Complex Assessments or Simple Management Procedures for Efficient Fisheries Management: A Comparative Study}. ICES J. Mar. Sci. 72(1): 262‑274.

\leavevmode{\hypertarget{ref-gertseva2017}{}}%
Gertseva, V., et Cope, J.M. 2017. \link{https://www.pcouncil.org/groundfish/stock-assessments/}{Stock assessment of the yelloweye rockfish ({\emph{Sebastes ruberrimus}}) in state and Federal waters off {California, Oregon and Washington}}. Pacific Fishery Management Council.
...
Haggarty, D.R., Shurin, J.B., et Yamanaka, K.L. 2016. \link{http://dx.doi.org/10.1016/j.fishres.2016.06.001}{Assessing population recovery inside {British Columbia's} Rockfish Conservation Areas with a remotely operated vehicle}. Fish. Res. 183: 165‑179.

\leavevmode{\hypertarget{ref-haggarty2018}{}}%
Haggarty, D., et Yamanaka, L. 2018. \link{https://doi.org/10.1016/j.ecss.2018.05.011}{Evaluating Rockfish Conservation Areas in southern {British Columbia, Canada} using a Random Forest model of rocky reef habitat}. Estuar. Coast. Shelf. S. 208: 191‑204.
...
Head, M.A., Stokes, G.L., Thorson, J.T., et Keller, A.A. 2016. \link{http://dx.doi.org/10.1016/j.fishres.2016.03.004}{Techniques for improving estimates of maturity ogives in groundfish using double-reads and measurement error models}. Fish Res. 179: 251‑258.
...
Holt, K.R., King, J.R., et Krishka, B.A. 2016. \link{https://waves-vagues.dfo-mpo.gc.ca/Library/363960.pdf}{Stock Assessment for Lingcod ({\emph{Ophiodon elongatus}}) in the {Strait} of {Georgia}, {British Columbia} in 2014}. DFO Can. Sci. Advis. Sec. Res. Doc. (2016/013).

\leavevmode{\hypertarget{ref-huynh_msetool_2019}{}}%
Huynh, Q.C., Hordyk, A.R., et Carruthers, T. 2019. \link{https://cran.r-project.org/package=MSEtool}{{MSEtool}: Management Strategy Evaluation Toolkit. R package version 1.4.3}.

\leavevmode{\hypertarget{ref-kell2006}{}}%
Kell, L.T., De Oliveira, J.A.A., Punt, A.E., McAllister, M.K., et Kuikka, S. 2006. \link{https://doi.org/10.1016/S0167-9309(06)80018-9}{Chapter 15 {Operational} Management Procedures: {An} Introduction to the Use of Evaluation Frameworks}. Developments in Aquaculture and Fisheries Science 36: 379‑407.
...
Kimura, D.K., et Tagart, J.V. 1982. \link{https://doi.org/10.1139/f82-198}{Stock {Reduction Analysis}, Another Solution to the Catch Equations}. Can. J. Fish. Aquat. Sci. 39(11): 1467‑1472.
...
Kristensen, K., Nielsen, A., Berg, C.W., Skaug, H., et Bell, B.M. 2016. \link{https://doi.org/10.18637/jss.v070.i05}{{TMB}: Automatic Differentiation and {Laplace} Approximation}. J. Stat. Softw. 70(5): 1‑21.

\leavevmode{\hypertarget{ref-kronlund2020}{}}%
Kronlund, A.R., Marentette, J.R., Olmstead, M., Shaw, J., et Beauchamp, B. 2021. Considérations pour la conception des stratégies de rétablissement des stocks de poissons canadiens. Secr. can. de consult. sci. du MPO. Doc. de rech.: In press.

\leavevmode{\hypertarget{ref-kuriyama2018}{}}%
Kuriyama, P.T., Branch, T.A., Hicks, A.C., Harms, J.H., et Hamel, O.S. 2018. \link{https://doi.org/10.1139/cjfas-2017-0286}{Investigating three sources of bias in hook-and-line surveys: survey design, gear saturation, and multispecies interactions}. Can. J. Fish. Aquat. Sci. 76(2): 192‑207.
...
Lindgren, F., Rue, H., et Lindström, J. 2011. \link{https://doi.org/10.1111/j.1467-9868.2011.00777.x}{An Explicit Link between {Gaussian} Fields and {Gaussian Markov} Random Fields: The Stochastic Partial Differential Equation Approach}. J. R. Stat. Soc. B. 73(4): 423‑498.

\leavevmode{\hypertarget{ref-livingston2017}{}}%
Livingston, P.A., Aydin, K., Buckley, T.W., Lang, G.M., Yang, M.-S., et Miller, B.S. 2017. \link{https://doi.org/10.1007/s10641-017-0587-0}{Quantifying food web interactions in the North Pacific -- a data-based approach}. Environmental Biology of Fishes 100(4, 4): 443‑470.
...
Logan, G., Mare, W. de la, King, J., et Haggarty, D. 2005. \link{https://waves-vagues.dfo-mpo.gc.ca/Library/317032.pdf}{Management framework for {Strait} of {Georgia Lingcod}}. DFO Can. Sci. Advis. Sec. Res. Doc. (2005/048).
...
Miller, D.C.M., et Shelton, P.A. 2010. \link{https://doi.org/10.1093/icesjms/fsq083}{"{Satisficing}" and trade-offs: evaluating rebuilding strategies for {Greenland} halibut off the east coast of {Canada}}. ICES J. Mar. Sci. 67(9): 1896‑1902.
...
MPO. 2009. \link{https://www.dfo-mpo.gc.ca/reports-rapports/regs/sff-cpd/precaution-back-fiche-eng.htm}{Cadre décisionnel pour les pêches en conformité avec l'approche de précaution}.

\leavevmode{\hypertarget{ref-dfo_dlmtool_2017}{}}%
MPO. 2017. {DLMtool} Phase {II}: Developing a Management Strategy Evaluation Package for Advancing the Science and Management of Data-limited and at-risk {Canadian} Fish Stocks. {PAC}2016.12.

\leavevmode{\hypertarget{ref-dfo2020}{}}%
MPO. 2020. Évaluation des procédures de gestion du hareng du {Pacifique} ({\emph{Clupea pallasii}}) dans les zones de gestion à {Haida Gwaii}, du district de {Prince Rupert} et de la côte centrale de la {Colombie-Britannique}.
...
Olson, A., Frid, A., Santos, J., et Juanes, F. 2020. \link{https://doi.org/10.3354/meps13275}{Trophic position scales positively with body size within but not among four species of rocky reef predators}. Mar. Ecol. Prog. Ser.

\leavevmode{\hypertarget{ref-punt2017}{}}%
Punt, A.E. 2017. \link{https://doi.org/10.1093/icesjms/fsv193}{Strategic Management Decision-Making in a Complex World: Quantifying, Understanding, and Using Trade-Offs}. ICES J. Mar. Sci. 74.

\leavevmode{\hypertarget{ref-punt2016}{}}%
Punt, A.E., Butterworth, D.S., de Moor, C.L., De Oliveira, J.A.A., et Haddon, M. 2016. \link{https://doi.org/10.1111/faf.12104}{Management Strategy Evaluation: Best Practices}. Fish Fish. 17(2): 303‑334.

\leavevmode{\hypertarget{ref-r2019}{}}%
R Core Team. 2019. R: A Language and Environment for Statistical Computing. {R Foundation for Statistical Computing}, Vienna, Austria.

\leavevmode{\hypertarget{ref-rademeyer2007}{}}%
Rademeyer, R.A., Plagányi, É.E., et Butterworth, D.S. 2007. \link{https://doi.org/10.1093/icesjms/fsm050}{Tips and Tricks in Designing Management Procedures}. ICES J. Mar. Sci. 64(4): 618‑625.

\leavevmode{\hypertarget{ref-rose2001}{}}%
Rose, K.A., Cowan, J.H., Winemiller, K.O., Myers, R.A., et Hilborn, R. 2001. \link{https://doi.org/10.1046/j.1467-2960.2001.00056.x}{Compensatory density dependence in fish populations: {Importance}, controversy, understanding and prognosis: {Compensation} in fish populations}. Fish. Fish. 2(4): 293‑327.

\leavevmode{\hypertarget{ref-rue2016}{}}%
Rue, H., Riebler, A., Sørbye, S.H., Illian, J.B., Simpson, D.P., et Lindgren, F.K. 2016. \link{https://arxiv.org/abs/1604.00860}{Bayesian {Computing} with {INLA}: {A Review}}. ArXiv160400860 Stat.
...
Shelton, A.O., Thorson, J.T., Ward, E.J., et Feist, B.E. 2014. \link{https://doi.org/10.1139/cjfas-2013-0508}{Spatial semiparametric models improve estimates of species abundance and distribution}. Can. J. Fish. Aquat. Sci. 71(11): 1655‑1666.
...
Siegle, M.R., Taylor, E.B., Miller, K.M., Withler, R.E., et Yamanaka, K.L. 2013. \link{https://doi.org/10.1371/journal.pone.0071083}{Subtle Population Genetic Structure in {Yelloweye Rockfish} ({\emph{Sebastes ruberrimus}}) Is Consistent with a Major Oceanographic Division in {British Columbia, Canada}}. PLoS ONE 8(8): e71083.

\leavevmode{\hypertarget{ref-stanley2009}{}}%
Stanley, R.D., Olsen, N., et Fedoruk, A. 2009. \link{https://doi.org/10.1577/C09-005.1}{Independent Validation of the Accuracy of {Yelloweye Rockfish} Catch Estimates from the {Canadian} Groundfish Integration Pilot Project}. Mar. Coast. Fish. 1(1): 354‑362.
...
Starr, R.M., Wendt, D.E., Barnes, C.L., Marks, C.I., Malone, D., Waltz, G., Schmidt, K.T., Chiu, J., Launer, A.L., Hall, N.C., et Yochum, N. 2015. \link{https://doi.org/10.1371/journal.pone.0118502.}{Variation in Responses of Fishes across Multiple Reserves within a Network of Marine Protected Areas in Temperate Waters}. PLOS ONE 10: e0118502.

\leavevmode{\hypertarget{ref-szoboszlai2015}{}}%
Szoboszlai, A.I., Thayer, J.A., Wood, S.A., Sydeman, W.J., et Koehn, L.E. 2015. \link{https://doi.org/10.1016/j.ecoinf.2015.07.003}{Forage species in predator diets: {Synthesis} of data from the {California Current}}. Ecol. Inform. 29: 45‑56.

\leavevmode{\hypertarget{ref-thorson2015}{}}%
Thorson, J.T., Shelton, A.O., Ward, E.J., et Skaug, H.J. 2015. \link{https://doi.org/10.1093/icesjms/fsu243}{Geostatistical Delta-Generalized Linear Mixed Models Improve Precision for Estimated Abundance Indices for {West Coast} Groundfishes}. ICES J. Mar. Sci. 72(5): 1297‑1310.

\leavevmode{\hypertarget{ref-walters2006}{}}%
Walters, C.J., Martell, S.J.D., et Korman, J. 2006. \link{https://doi.org/10.1139/f05-213}{A stochastic approach to stock reduction analysis}. Can. J. Fish. Aquat. Sci. 63(1): 212‑223.

\leavevmode{\hypertarget{ref-warner1985}{}}%
Warner, R.R., et Chesson, P.L. 1985. \link{}{Coexistence Mediated by Recruitment Fluctuations: A Field Guide to the Storage Effect}. The American Naturalist 125(6): 769‑787.

\leavevmode{\hypertarget{ref-winemiller2005}{}}%
Winemiller, K.O. 2005. \link{https://doi.org/10.1139/f05-040}{Life history strategies, population regulation, and implications for fisheries management}. Can. J. Fish. Aquat. Sci. 62(4): 872‑885.

\leavevmode{\hypertarget{ref-winemiller1992}{}}%
Winemiller, K.O., et Rose, K.A. 1992. \link{https://doi.org/10.1139/f92-242}{Patterns of Life-History Diversification in {North} {American} Fishes: implications for Population Regulation}. Can. J. Fish. Aquat. Sci. 49(10): 2196‑2218.
...
Yamanaka, K., et Logan, G. 2010. \link{https://doi.org/10.1577/C08-036.1}{Developing {British Columbia's} Inshore Rockfish Conservation Strategy}. Mar. Coast. Fish. 2: 28‑46.
...
{\centering \pdftooltip{\includegraphics[width=6in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/age-freq}}{Figure \ref{fig:age-freq}} 
...
{\centering \pdftooltip{\includegraphics[width=4in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-ins-age-precision}}{Figure \ref{fig:age-precision}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/length-freq}}{Figure \ref{fig:length-freq}} 
...
{\centering \pdftooltip{\includegraphics[width=0.6\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/length-weight}}{Figure \ref{fig:length-weight}} 
...
{\centering \pdftooltip{\includegraphics[width=0.6\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/vb}}{Figure \ref{fig:length-age}} 
...
{\centering \pdftooltip{\includegraphics[width=0.6\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/mat-ogive-age}}{Figure \ref{fig:percent-maturity}} 
...
{\centering \pdftooltip{\includegraphics[width=0.6\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/mat-prop}}{Figure \ref{fig:prop-mature}} 
...
{\centering \pdftooltip{\includegraphics[width=0.6\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/mat-months}}{Figure \ref{fig:mat-months}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs/YE_Inside_2019_HBLL_L_fr}}{Figure \ref{fig:map-HBLL-NS}} 
...
\newcounter{appendix_2_appsection_1_counter}
\refstepcounter{appendix_2_appsection_1_counter}
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-raw-data}}{Figure \ref{fig:hbll-raw}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-area-in-water}}{Figure \ref{fig:hbll-area-grid}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-baited}}{Figure \ref{fig:hbll-baited}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-hook-adjust}}{Figure \ref{fig:hbll-hook-adjustment}} 
...
{\centering \pdftooltip{\includegraphics[width=0.6\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-spde}}{Figure \ref{fig:hbll-spde}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-prediction-log}}{Figure \ref{fig:hbll-predicted-spacetime}} 
...
{\centering \pdftooltip{\includegraphics[width=4.2in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-omega}}{Figure \ref{fig:hbll-spatial-re}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-joint-epsilon}}{Figure \ref{fig:hbll-spatiotemporal-re}} 
...
{\centering \pdftooltip{\includegraphics[width=4in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/hbll-index-components-eps-depth2}}{Figure \ref{fig:hbll-index}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/geostatistical-sim-predicted}}{Figure \ref{fig:stich-sim-pred}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/geostatistical-sim-stitched-index}}{Figure \ref{fig:stich-sim-index}} 
...
\newcounter{appendix_2_appsection_2_counter}
\refstepcounter{appendix_2_appsection_2_counter}
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/dogfish-yelloweye-per-area-data}}{Figure \ref{fig:dog-raw}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/dogfish-prediction-log}}{Figure \ref{fig:dog-prediction}} 
...
{\centering \pdftooltip{\includegraphics[width=4.2in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/dogfish-omega}}{Figure \ref{fig:dog-spatial}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/dogfish-epsilon}}{Figure \ref{fig:dog-spatiotemporal}} 
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/dogfish-index-estimated-hook}}{Figure \ref{fig:dog-standardized-index}} 
...
En 2012, le MPO a établi un relevé sur Internet destiné aux détenteurs de permis de pêche en eaux de marées à l'échelle de la côte (iRec) qui permet de recueillir des données sur le sébaste aux yeux jaunes (\protect\hyperlink{ref-dfo2015}{DFO 2015}). Toutefois, on n'a pas étalonné les résultats de ce relevé pour tenir compte des incertitudes comme le biais de non-réponse. C'est pourquoi les données iRec n'ont pas été incluses dans cette analyse.

\newcounter{appendix_3_appsection_2_counter}
\refstepcounter{appendix_3_appsection_2_counter}
...
\toprule
\textbf{Année} & \textbf{SGPP 13} & \textbf{SGPP 14} & \textbf{SGPP 15} & \textbf{SGPP 16} & \textbf{SGPP 17} & \textbf{SGPP 18} & \textbf{SGPP 19} & \textbf{SGPP 20} & \textbf{SGPP 28} & \textbf{SGPP 29} & \textbf{SGPP 12} & \textbf{Effort}\\
\midrule
\endfirsthead
\caption*{}\\
\toprule
...
\newcounter{appendix_4_counter}
\refstepcounter{appendix_4_counter}
\appsection{DESCRIPTIONS DES TIROIRS DU STOCK}
\label{app:desc-stock-yelloweye}

\newcounter{appendix_4_appsection_1_counter}
\refstepcounter{appendix_4_appsection_1_counter}
\subsection{maxage}
...
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{91283}\NormalTok{)}
\NormalTok{OM}\SpecialCharTok{@}\NormalTok{cpars}\SpecialCharTok{$}\NormalTok{M }\OtherTok{\textless{}{-}} \FunctionTok{rlnorm}\NormalTok{(nsim, }\FunctionTok{log}\NormalTok{(}\FloatTok{0.045}\NormalTok{) }\SpecialCharTok{{-}} \FloatTok{0.5} \SpecialCharTok{*} \FloatTok{0.2}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{, }\FloatTok{0.2}\NormalTok{)}

\FunctionTok{set.seed}\NormalTok{(}\DecValTok{91283}\NormalTok{)}
\NormalTok{OM\_Scenario\_A}\SpecialCharTok{@}\NormalTok{cpars}\SpecialCharTok{$}\NormalTok{M }\OtherTok{\textless{}{-}} \FunctionTok{rlnorm}\NormalTok{(nsim, }\FunctionTok{log}\NormalTok{(}\FloatTok{0.025}\NormalTok{) }\SpecialCharTok{{-}} \FloatTok{0.5} \SpecialCharTok{*} \FloatTok{0.2}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{, }\FloatTok{0.2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{OM}\SpecialCharTok{@}\NormalTok{cpars}\SpecialCharTok{$}\NormalTok{h }\OtherTok{\textless{}{-}}\NormalTok{ h\_samps}
\end{Highlighting}
\end{Shaded}
\begin{Shaded}
\begin{Highlighting}[]
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{create\_maturity\_ogive }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(A50, A95, maxage, Amin) \{}
\NormalTok{  ages }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{:}\NormalTok{maxage}
\NormalTok{  mat\_age }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{+} \FunctionTok{exp}\NormalTok{(}\FunctionTok{log}\NormalTok{(}\DecValTok{19}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ (ages }\SpecialCharTok{{-}}\NormalTok{ A50)}\SpecialCharTok{/}\NormalTok{(A95 }\SpecialCharTok{{-}}\NormalTok{ A50)))}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{ifelse}\NormalTok{(ages }\SpecialCharTok{\textless{}}\NormalTok{ Amin, }\DecValTok{0}\NormalTok{, Amin, mat\_age))}
\NormalTok{\}}
\NormalTok{OM}\SpecialCharTok{@}\NormalTok{cpars}\SpecialCharTok{$}\NormalTok{Mat\_age }\OtherTok{\textless{}{-}} \FunctionTok{create\_maturity\_ogive}\NormalTok{(}\FloatTok{14.4}\NormalTok{, }\FloatTok{27.4}\NormalTok{, OM}\SpecialCharTok{@}\NormalTok{maxage, }\DecValTok{7}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{array}\NormalTok{(OM}\SpecialCharTok{@}\NormalTok{maxage, OM}\SpecialCharTok{@}\NormalTok{nyears }\SpecialCharTok{+}\NormalTok{ OM}\SpecialCharTok{@}\NormalTok{proyears, OM}\SpecialCharTok{@}\NormalTok{nsim) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{aperm}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
\subsection{a}
...
\newcounter{appendix_4_appsection_2_counter}
\refstepcounter{appendix_4_appsection_2_counter}
...
{\centering \pdftooltip{\includegraphics[width=6.3in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/HBLL-selectivity}}{Figure \ref{fig:HBLL-selectivity}} 
...
{\centering \pdftooltip{\includegraphics[width=3.8in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/fishery-selectivity2}}{Figure \ref{fig:sra-selectivity}} 
...
{\centering \pdftooltip{\includegraphics[width=4.5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/fishery-selectivity-terminal-year}}{Figure \ref{fig:om-selectivity}} 
...
\newcounter{appendix_4_appsection_3_counter}
\refstepcounter{appendix_4_appsection_3_counter}
\subsection{Cobs}
...
\newcounter{appendix_4_appsection_4_counter}
\refstepcounter{appendix_4_appsection_4_counter}
\subsection{TACFrac}
...
\newcounter{appendix_5_counter}
\refstepcounter{appendix_5_counter}
...
\newcounter{appendix_5_appsection_2_counter}
\refstepcounter{appendix_5_appsection_2_counter}
...
\newcounter{appendix_5_appsection_2_subsection_2_counter}
\refstepcounter{appendix_5_appsection_2_subsection_2_counter}
...
{\centering \pdftooltip{\includegraphics[width=3in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/historical_indicators2}}{Figure \ref{fig:cosewic-metrics}} 
...
{\centering \pdftooltip{\includegraphics[width=\textwidth]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tigure-cosewic-all}}{Figure \ref{fig:cosewic-all}} 
...
{\centering \pdftooltip{\includegraphics[width=3in]{/Volumes/Extreme-SSD/src/yelloweye-inside/mse/figures-french/ye-tigure-cosewic-avg}}{Figure \ref{fig:cosewic-avg}} 
...
Cette version du document a été produite sur 2022-01-06 12:59:44 avec R version 4.1.2 (2021-11-01) (\protect\hyperlink{ref-r2019}{R Core Team 2019}) et des versions du progiciel R:
\begin{longtable}[]{@{}llll@{}}
\toprule
& Paquet & Version & Date \\
\midrule
