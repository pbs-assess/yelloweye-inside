...
\starredchapter{APPENDIX~\thechapter. DONNÉES DES RELEVÉS INDÉPENDANTES DE LA PÊCHE}
...
\starredchapter{APPENDIX~\thechapter. DONNÉES SUR LES PRISES}
...
\starredchapter{APPENDIX~\thechapter. DÉFINITION DU MODÈLE OPÉRATIONNEL DU SÉBASTE AUX YEUX JAUNES DES EAUX INTÉRIEURES}
...
\refstepcounter{chapter}
\label{app:mps}
\starredchapter{APPENDIX~\thechapter. PROCÉDURES DE GESTION À DONNÉES LIMITÉES}
...
\starredchapter{APPENDIX~\thechapter. PRÉDATION PAR LES PINNIPÈDES}
...
\refstepcounter{chapter}
\label{app:cosewic}
\starredchapter{APPENDIX~\thechapter. FACTEURS CONSIDÉRÉS PAR LE COSEPAC}
...
\starredchapter{APPENDIX~\thechapter. ENVIRONNEMENT INFORMATIQUE}\label{environnement-informatique}}

Cette version du document a été produite sur 2021-10-29 11:57:55 avec R version 3.6.3 (2020-02-29) (R Core Team \protect\hyperlink{ref-r2019}{2019}) et des versions du progiciel R:
\begin{longtable}[]{@{}llll@{}}
\toprule
