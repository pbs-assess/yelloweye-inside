...
COSEPAC. 2019. \link{http://cosewic.ca/index.php/en-ca/assessment-process/wildlife-species-assessment-process-categories-guidelines/quantitative-criteria}{Évaluation des espèces sauvages du {COSEPAC}~: processus d'évaluation, catégories et lignes directrices}. Comité sur la situation des espèces en péril au Canada.
...
DFO. 2009. \link{https://www.dfo-mpo.gc.ca/reports-rapports/regs/sff-cpd/precaution-back-fiche-eng.htm}{Cadre décisionnel pour les pêches en conformité avec l'approche de précaution}.
...
{\centering \pdftooltip{\includegraphics[width=5in]{/Volumes/Extreme-SSD/src/yelloweye-inside/figs-french/YE_Inside_2019_HBLL_L}}{Figure \ref{fig:map-HBLL-NS}} 
...
\appsection{PROCÉDURES DE GESTION FONDÉES SUR UN MODÈLE}\label{sec:mp-model-based}}

\newcounter{appendix_5_appsection_3_counter}
\refstepcounter{appendix_5_appsection_3_counter}
