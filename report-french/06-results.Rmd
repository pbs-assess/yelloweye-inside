...
knitr::include_graphics(here("mse/figure-french/ye-tigure-refset.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-dot-refset-avg.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-tradeoff-refset-avg.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-radar-refset-avg.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-index.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-updog_fixsel.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-lowcatch_fixsel.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-episodic_recruitment.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-upweight_dogfish.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-kobe.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-worms.png"))
```
...
knitr::include_graphics(here::here("mse/figure-french/ye-compare-SRA-nat-recdev-panel-proj.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-tigure-robset.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-dot-robset.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-tradeoff-robset.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-radar-robset.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-lowM_fixsel.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-high_index_cv.png"))
```
...
knitr::include_graphics(here("mse/figure-french/ye-projections-scenarios.png"))
```
