#get inside hard bottom longline survey hook competition data for inside yelloweye
load_all("../gfdata")
d <- run_sql("GFBioSQL", "SELECT S.SURVEY_DESC AS Survey,
...
write.csv(d, "D:/YE rebuilding plan/hook-comp-data.csv")
