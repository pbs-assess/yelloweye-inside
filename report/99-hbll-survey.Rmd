...
```{r, fig.cap="The raw data. Gray background shading indicates the northern and southern survey areas. The area of the circles represents the raw number of fish caught not adjusting for number of hooks or hook competition."}
