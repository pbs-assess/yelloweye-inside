...
# DOGFISH SURVEY
** TODO: Dogfish survey paragraph by Midoli**
The Pacific Spiny Dogfish (*Squalus suckleyi*) survey samples nine locations in the Strait of Georgia that were historically fished by the commercial Dogfish fishery [@King2012]. The survey was first carried out in 1986, with subsequent sampling in 1989, 2005, 2011, 2014, and 2019. In 2004 a separate calibration study was undertaken to assess the potential for a change in catch rates due to a switch from J-hooks to circle hooks on survey gear. 

The survey is a depth stratified longline survey that uses snap on gear with 300 circle hooks baited with herring and a two hour soak time. Hook by hook data is collected onboard by DFO technicians, along with biological information on captured Rockfish species. A more detailed description of survey methods is provided in [@King2012]. 
