...
1. Rebuilding metrics
  * P(B~t=2075~ > LRP) after 1.5 generations (56 years) > 95% to satisfice
  * P(B~t=2057~ > LRP) after 1 generation time (38 years)
  * P(B~t=2075~ > USR) after 1.5 generations (56 years)
  * P(B~t~ > B~t-10~ or B > LRP) milestone objective
2. Economic metrics
  * P(*F* > *F*~MSY~) during projection period
  * P(Catch >= 15 tonnes)
