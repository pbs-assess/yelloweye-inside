...
This may be done through informal means, such as through feedback from fishers and survey information [e.g., @cox2008], or through more formal statistical measures, where observed data are compared to predictions from the OMs to test whether the system is performing as expected [@carruthers_hordyk_2018; discussed in @anderson2020gfmp].

Below, we describe the methods used for developing a candidate rebuilding plan for Inside Yelloweye Rockfish, following the six best practice steps.
...
[@dfo2006; @dfo2009] and rebuilding plan guidance [@dfo2013], elements of which
are incorporated into the Fish Stocks provisions of the *Fisheries Act* (see
Section \@ref(motivation)). Additional objectives related to fisheries yield
and variability in annual fisheries yield are based on precedents in other DFO
Pacific Region analyses [e.g., @cox2008a; @forrest2018; @cox2019].
