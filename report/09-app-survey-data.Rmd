...
\begin{align}
N_{i,t}^{(0)} & = \frac{-\ln P_{i,t}}{1 - P_{i,t}} N_{i,t}\\
              & = A_{i,t} N_{i,t}.
(\#eq:Nit)
\end{align}
...
$$
A_{i,t} = - \frac{ \left(\ln(P_{i,t} \right)}{1 - P_{i,t}}.
...
Specifically, it was represented as $\ln \left(S_{i,t} / A_{i,t} \right)$, where $S_{i,t}$ represents the area "swept" by the set.
