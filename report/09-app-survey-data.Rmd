...
We fit our model with TMB [@tmb], by ...
...
We use a spatiotemporal model to estimate the density of Yelloweye Rockfish per km^2^. We calculate the area swept by multiplying the number of hooks deployed by the estimated width swept by the length of two gangions and the estimated distance between hooks (8ft spacing).
