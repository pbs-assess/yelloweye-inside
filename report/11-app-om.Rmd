...
Selectivity-at-age in the HBLL survey was set to give 5% selectivity at 6.8 *y* and full selectivity at age = 22 *y*, in all scenarios except Scenario (4), where selectivity-at-age was estimated using available age-composition data (Figure \@ref(fig:HBLL-selectivity)).
