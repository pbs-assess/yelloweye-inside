...
```{r desc-stock-m-yelloweye, results = knitr_results, echo = knitr_echo, fig.cap="Distributions of natural mortality (*M*) used in the OM scenarios. All OMs used the same distributions except \"(A) Low M\"."}
display_om(oms, "M")
```
<!-- slot-chunk-end -->
...
```{r desc-stock-h-yelloweye, results = knitr_results, echo = knitr_echo, fig.cap="Distributions of steepness (*h*) used in the OM scenarios. All OMs used the same *h* samples."}
display_om(oms, "h")
```
<!-- slot-chunk-end -->
