...
TODO: M ~ Lognormal(0.045, 0.2) from Hoenig et al. (1983) using maxage = 101 years (Appendix \@ref(app:biological-data), Figure \@ref(fig:age-freq)). Also cite Yamanaka et al. (2011) for the standard deviation of 0.2.
...
This value was estimated from Appendix \@ref(app:biological-data), Figure \@ref(fig:length-age). No sexual dimorphism was observed, so this parameter was estimated for both males and females combined.
...
Maturity was directly overwritten as an age-based function. Female maturity at age was estimated from Appendix \@ref(app:biological-data), Figure \@ref(fig:percent-maturity) and used here. The minimum age observed to be mature was 7 years and it assumed that younger ages were all immature.
...
This value was estimated from Appendix \@ref(app:biological-data), Figure \@ref(fig:length-weight). No sexual dimorphism was observed, so this parameter was estimated for both males and females combined.
