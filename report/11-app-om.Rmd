...
TODO: see next temporary chunk; this isn't SD = 0.15!
...
set.seed(65423)
h_alpha <- DLMtool::alphaconv(0.6375, 0.12)
h_beta <- DLMtool::betaconv(0.6375, 0.12)
...
*TODO: Possibly add some of the SRA plots here if too numerous for main document*
