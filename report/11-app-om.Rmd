...
Selectivity-at-age in the HBLL survey was set to give full selectivity-at-age = 20 *y*, in all scenarios except Scenario (4), where it was estimated using available age-composition data (Figure \@ref(fig:HBLL-selectivity)).
See Section \@ref(sec:approach3-conditioning-base-om).
Selectivity in the Dogfish Survey was set to mirror selectivity in the HBLL survey.
...
For the recreational fleet, the age-at-50% and 95% selectivity was 6.7 and 11.5 years, respectively.
For the commercial hook and line fleet, the age-at-50% and 95% selectivity was 14.4 and 21 years, respectively.
...
For the projeciton period ($t > t_c$), the DLMtool OM only accommodates one fishing fleet.
