...
Multidimensional trade-offs were challenging to interpret via a radar plot for this closed-loop-simulation (Figure \@ref(fig:spider-satisficed-mps-avg)) and exemplify some of the warnings about radar plots offered in @anderson2020gfmp.
We included them to gauge reader interest at the Regional Peer Review meeting and as an illustration of their pitfalls for the MP Framework.
