...
Scenario (A) lowered the probability of achieving the LRP 1.5GT performance metric from >0.99 probability in the reference set to a range of 0.75--0.90 (Figure \@ref(fig:tigure-panel-rob) vs. \@ref(fig:tigure-panel)).
We saw similar declines in the other conservation performance metrics.
Scenario (B) slightly lowered the probability of achieving the ST C10 performance metric (Figure \@ref(fig:tigure-panel-rob) vs. \@ref(fig:tigure-panel)), presumably because of the added error in the projected HBLL index.
...
By comparing the projections across scenarios on the same figure, we can see that *F*/*F*~MSY~, *B*/*B*~MSY~, and catch were most sensitive to the Scenario (A) assumptions and mildly sensitive to the Scenario (4) assumptions (Figure \@ref(fig:proj-scenarios)). 
