...
The reference MP FMSYref indicates that catches could be increased without increasing the likelihood of falling below LRP. This is due to high probability that the stock is currently above LRP across the reference set scenarios. 
