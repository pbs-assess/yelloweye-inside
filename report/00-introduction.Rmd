...
The MP Framework extensively utilizes the functionality of DLMtool and MSEtool, supported by an R package gfdlm [@gfdlm] written by the authors of @anderson2020gfmp, which houses a suite of software support tools and custom visualizations.
