...
Similar to how some of the FSC catch is accounted with the commercial catch data, some FSC effort from small boats will be captured in the recreational data from the creel survey program.
...
The proportion of FSC fisher encountered by the dockside creel monitor was not, however, readily available in the recreational database (CREST) (P. Zetterberg, DFO, pers. comm., November 29, 2019).
