...
*TODO: please provide the years for which the reconstruction was done ---- There was an issue with how we used the reconstructed (1918-1985) vs raw commercial data (1985-2019), which I tried to explain in paragraph 4. The "credible period" of data used in the reconstruction is from 1997-2005. see explanation in paragraph 1. They ended in 2005 because that was the last year of data in one of the databases they were using -- MJB* 
...
The second major source of uncertainty is the magnitude of unreported catch that was released or discarded at sea, prior to the introduction of 100% observer coverage in 2006. The catch reconstruction of @haigh2011 assumes no discarding prior to 1986 and that discards are fully reported in DFO databases since 2006. Non-retained Yelloweye Rockfish catch (releases or discards) was estimated for each fishery using the ratio of Yelloweye discarded by a fishery to fishery-specific landed targets using data from 2000-2004 hook and line observer logs. The estimated historical unreported catch was then incorporated into the catch reconstruction, giving a final annual total.  *TODO: What about discarding between 1986 and 2005? Is this covered by the doubling? If so please explain --- I do not know the answer to this. The reconstruction was completely separate from the last assessment. I think the fishermen decided they didn't trust the log books and so they insisted on doubling the catch for those years, but the algorithm didn't take that concern into account. They found "useful" information in the observer logs. At least that is what is written in the paper --- MJB*

Raw commercial catch data for Inside Yelloweye was extracted from the GFCatch database, which is maintained by the groundfish data unit at DFO.
An earlier version of the catch reconstruction algorithm was used to develop the commercial catch time series used in the previous stock assessment for Inside Yelloweye Rockfish [@yamanaka2011], as the final version was not yet published. Further refinements to the reconstruction algorithm resulted in significant changes to the estimated historical catch in some years (Norm Olsen, DFO, Pacific Biological Station, pers. comm., March 9,2020 ).
As well, ongoing quality control and updates to the groundfish catch database may result in minor differences in the data over time (Maria Surry, DFO, Pacific Biological Station, pers. comm., March 9, 2020 ).For these reasons, the time series of commercial catch used in the current analysis differs from that used in the most recent stock assessment from 2009.

For consistency with the previous assessment for Inside Yelloweye Rockfish [@yamanaka2011], the total commercial catch for 1986-2005 used to calibrate our OMs was doubled.
@yamanaka2011 made the decision to double the catch for those years, based on feedback from the commercial industry that they did not have confidence in commercial logbooks for this period [@dfo2012].
