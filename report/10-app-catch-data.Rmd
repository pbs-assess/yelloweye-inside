...
The reconstruction algorithm can be applied to all years in the timeseries, up to 2005 because after 2006 there is no need, due to full reporting. However, for this analysis we used the reconstructed catch data from 1918-1985, switching to nominal catch data in 1986. The nominal catch from 1986-2005 was then doubled to calibrate our OMs,to be consistent with the previous assessment [@yamanaka2011]. In 2009, advice from industry representatives indicated that the scale of unreported catch was equal to landed catch. Because discards are estimated as part of the catch reconstruction we decided to stop using the reconstructed catch in 1985 to avoid double counting of discards.   
