...
Age data for inside Yelloweye Rockfish, using the break and burn method, are available from various surveys in area 4B from 1984-2018. Proportions-at-age of Yelloweye Rockfish are shown by year and sex for the inside stock from research samples (Figure \@ref(fig:age-freq)). Directed hard-bottom longline (HBLL) surveys began in area 4B in 2003 after which greater numbers of Yelloweye Rockfish were aged.
