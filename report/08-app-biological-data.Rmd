...
Yelloweye Rockfish are a long-lived species, with a reported maximum age of 121 for the outside stock [@keppel2019]. The maximum age for Inside Yelloweye is 101 years, updated from the previously reported max age of 98 years, based on additional recent aging data (Figure \@ref(fig:age-freq)). 
