...
Inside Yelloweye Rockfish, which reside in area 4B (Strait of Georgia, Johnstone Strait, and Queen Charlotte Strait), are genetically distinct from the outside population of Yelloweye Rockfish whose range covers the rest of the coast [@Andrews2018; @Siegle2011; @Siegle2013] and are considered to be two separate "designatable units" by the Committee on the Status of Endangered Wildlife in Canada (COSEWIC) [@COSEWIC2008].
