...
These data-limitations pose a challenge to evaluation of the expected performance of rebuilding plans needed to bring the stock into compliance with the Fish Stocks provisions.
