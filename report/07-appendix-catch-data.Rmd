...
The data in the table below comes from the commercial dockside monitoring program and is collected from dual fishing trips, wherein indigenous fishers choose to keep some of their catch for FSC purposes. There is no discussion of this in the proceedings from the previous CSAS process in 2011 [@DFO2012c]. 
