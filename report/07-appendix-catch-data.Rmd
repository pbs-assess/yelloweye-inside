...
The data is collected at the trip level, not set level, therefore there may be issues with some of the reported catch being collected outside the geographic boundary for Inside Yelloweye. However, resolving this issue was outside the scope of this evaluation. 
