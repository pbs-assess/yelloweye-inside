...
As for all the index-based MPs, we set $\textrm{TAC}_\textrm{Floor} = 0.5 t$ , which is approximately the amount of catch required for surveys to continue.

OR

We assumed the default $\textrm{TAC}_\textrm{Floor}$ of 20% of the average catch from the last 5 historical years)

We evaluated three configurations of the IDX MPs, applied annually:

*TODO: Define the differences between these*
