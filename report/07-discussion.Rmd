...
Yelloweye Rockfish occupy a relatively high trophic position and Steller Sea Lions, Orca Whales (*Orcinus orca*) and Chinook Salmon (*Oncorhynchus tshawytscha*) are the only predators of Yelloweye Rockfish listed in a large data-base of predator-prey interactions (database assembled for @dunne2016; @szoboszlai2015). 
...
There are x# of RCAs in area 4B (Figure \@ref(fig:map-4B)) that protect an estimated 267 km^2 of rockfish habitat, amounting to 22% of available rockfish habitat in inside waters [@haggarty2018]. 
