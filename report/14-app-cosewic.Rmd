...
(ref:fig-cosewic-all)
COSEWIC assessment metrics for Inside Yelloweye Rockfish by OM. 

```{r cosewic-all, fig.cap="(ref:fig-cosewic-all)", out.width="0.8\\textwidth"}
library(here)
...
(ref:fig-cosewic-avg)
COSEWIC measures averaged across OMs for Inside Yelloweye Rockfish. 
