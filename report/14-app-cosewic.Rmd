...
Results for COSEWIC metric A, the probability that the stock has declined at least 30%, 50%, and 70% over the past 3 generations, for each operating model for Inside Yelloweye Rockfish where one generation is equal to 38 years. 
...
In order to examine the risk of extinction, stock-specific biomass thresholds must be assigned. Below these thresholds the stock would be considered functionally extirpated or extinct. We propose two extinction thresholds of 2%B~0~ and 5%B~0~ to quantitatively calculate risk of future extinction for each OM and MP scenario. While we acknowledge that these thresholds are arbitrary, precedents exist in the literature [@forrest2015] and simulation testing is required to find more appropriate stock-specific thresholds.
