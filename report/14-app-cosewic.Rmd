...
Results for COSEWIC metric A, the probability that the stock is above 70%, 50%, and 30% of *B*~1918~ after the past three generations, for each OM, where one generation is defined as 38 years. 
