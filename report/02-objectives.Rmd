...
For more information on generation time, please see \@ref(app:biological-data), Section \@ref(sec:generation).
...
We propose the following performance metrics to measure the objectives, where *B* represents spawning biomass, MSY refers to maximum sustainable yield, *B*~MSY~ refers to equilibrium spawning biomass at MSY, GT represents generation time, and AADC represents average absolute deviation in catch ($C$) over $n$ years (note: *ST* = short term, *LT* = long term). We define the LRP and USR as 0.4*B*~MSY~ and 0.8*B*~MSY~, respectively, following the provisional definitions in the PA Framework [@dfo2006], as used in the 2010 stock assessment [@yamanaka2011]. In the closed-loop simulations, all reference points and performance metrics are calculated in the OM. Raw performance metrics are calculated in each of the 100 years of the projection period and summarized according to the time-frame of interest:
...
4. **ST C10**: P(average catch > 10 t) during 2020--2029  
5. **ST C15**: P(average catch > 15 t) during 2020--2029
<!-- 6. ST C20: P(catch > 20 t) during 2020--2029 RF: we don't report this one-->
6. **LT C20**: P(average catch > 20 t) after 1 GT (38 years)
