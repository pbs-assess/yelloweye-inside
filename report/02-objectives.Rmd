...
1. **LRP 1.5GT**: P(*B* > 0.4 *B*~MSY~) after 1.5 GT (in year 56 of the projection period)
2. **USR 1.5GT**: P(*B* > 0.8 *B*~MSY~) after 1.5 GT (in year 56 of the projection period)
3. **LRP 1GT**: P(*B* > 0.4 *B*~MSY~) after 1 GT (in year 38 of the projection period)
4. **ST C10**: P(average catch > 10 t) during years 2020--2029  
5. **ST C15**: P(average catch > 15 t) during years 2020--2029
<!-- 6. ST C20: P(catch > 20 t) during 2020--2029 RF: we don't report this one-->
6. **LT C20**: P(average catch > 20 t) after 1 GT (in year 38 of the projection period)
