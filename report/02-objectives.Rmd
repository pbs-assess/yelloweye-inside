...
* LT C20: P(catch > 20 t) after 1 GT
* ST AADC: P(AADC during 2020-2029 < AADC during 2012 - 2019)
  
AADC represents average absolute deviation in catch ($C$) over $n$ years and is defined as:
...
For example, we averaged the short-term (ST) catch metrics over the years 2020--2029.
