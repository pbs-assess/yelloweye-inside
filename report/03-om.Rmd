...
None of the scenarios estimated current median spawning biomass to be below the LRP (Figure )
...
*TODO: Extra notes from Quang*

*TODO: Where do we find table or fig of reference points?*
...
*TODO: Where to put the SP model fit?*
