...
The OMs were conditioned using commercial and recreational catch data (Appendix \@ref(app:catch-data)), survey indices (Appendix \@ref(app:index-data)), and age-composition data from the inside Hard Bottom Longline (HBLL) survey (Appendix \@ref(app:biological-data)).
...
We developed four alternative OMs for inclusion in the reference set and two alternative OMs for inclusion in the robustness set, described below.
