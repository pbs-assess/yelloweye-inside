...
Instead of an observation SD drawn from Uniform(0.10, 0.25), we use the SD and autocorrelation from the index residuals in OM (1) for future projections of the HBLL index.
