...
In the current study, all index-based MPs utilize the HBLL survey. Model-based MPs utilize all historical indices, but only the HBLL survey in the projection period.
