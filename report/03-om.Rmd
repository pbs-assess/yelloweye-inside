...
However, only Scenario (B) estimates the stock to have been below the LRP during the 2000s (Figure \@ref(fig:biomass-om)).
...
The model used prior probability distributions for the intrinsic rate of population growth, carrying capacity, initial stock size relative to unfished stock size, and catchability coefficients for the indices of abundance, based on those used in @yamanaka2011.
...
Note that median reference point estimates of *B*~MSY~ = **XX**, *F*~MSY~ = 0.03 *y*^-1^, and MSY = 62 t werere similar to those from the SRA Base OM (Table \@ref(tab:sra-ref-pts)).

*TODO: What else do we want to say about this???*


(ref:fig-spm-biomass) Median biomass relative to biomass at MSY (*B*/*B*~MSY~) trajectory from the SP model.
Dotted horizontal lines represent the USR (0.8 *B*~MSY~) and LRP (0.4 *B*~MSY~).
...
*TODO: Quang, please add any more details, including value of BMSY and details about priors*
