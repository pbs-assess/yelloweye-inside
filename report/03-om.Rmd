...
*TODO: Simplify the text below and remove discussion of mohn's rho. RF will do this.*
...
Therefore, in the present analysis, for the "Base" scenario, and all other scenarios except "Estimate HBLL selectivity", it was decided to fix the age-at-full selectivity of the HBLL Survey to 20 years, while also upweighting the dogfish survey.
...
The SRA was able to fit to indices reasonably well for all OM scenarios (Figure \@ref(fig:survey-fits)).
