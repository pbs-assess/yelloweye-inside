...
(ref:fig-biomass-om)
Spawning stock biomass relative to spawning stock biomass at MSY (*B*/*B*~MSY~) trajectories for reference and robustness set OMs.
Lines represent medians, and dark and light grey shading represent 50% and 95% quantiles across replicates.
Dotted horizontal lines represent the USR and LRP.
