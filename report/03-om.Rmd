...
The SRA model fit the HBLL age-composition data reasonably well, despite very small sample sizes (Figures \@ref(fig:sra-comp-fit1) to \@ref(fig:sra-comp-fitB)).

We note that in comparing Scenarios (1) and (4), respectively fixing and estimating selectivity in the HBLL survey did not appear to generate very different fits in age composition data (Figures \@ref(fig:sra-comp-fit1) and \@ref(fig:sra-comp-fit4).
