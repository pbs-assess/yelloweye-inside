...
In all scenarios except Scenario (A), the median spawning biomass in 2019 is estimated to be above the LRP (Figure \@ref(fig:biomass-om)). 
Scenario (A) estimated median spawning biomass to have been below the LRP for most years post-2000 and more than 50% probability of being below the LRP in 2019 (Figure \@ref(fig:ref-pt)).
Scenario (2) and Scenario (4) also had a small probability of being below the LRP in the current year.
...
The median spawning biomass is estimated to be above the USR in Scenarios (1), (2), (3), and (B); and estimated to be below the USR in scenarios (4) and (A).
...
The credible interval for all scenarios except (A) was very broad, arising from uncertainties in natural mortality and steepness (Figure \@ref(fig:sra-conditioned-parameters)).
