...
This SD has a mean of `r round2(mean_Isd)` and a range of `r round2(range_Isd[1])`--`r round2(range_Isd[2])` compared to the base OM, which has a an SD drawn from Uniform(0.10, 0.25).
