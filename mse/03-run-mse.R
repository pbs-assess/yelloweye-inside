...
library(MSEtool)
source("mse/functions/YE_MPs.R")
setup(12)
sfExportAll()
sfLibrary(gfdlm)


scenario <- c("upweight_dogfish", "base", "low_catch", "sporadic_recruitment", "pinniped", "lowM")
...
for(i in 1:6) {
  ...
  myMSE3 <- runMSE(myOM, MPs = c("IDX_YE", "IDX_smooth_YE", "SP_4080_5f", "SP_4080_10f"), parallel = TRUE)
  #saveRDS(myMSE3, file = paste0("mse/OM/MSE_", scenario[i], "_IDX.rds"))
